...
public class KGNetworkDiscovery : NetworkDiscoveryBase<DiscoveryRequest, DiscoveryResponse>
{
    #region Server
    ...
    protected override DiscoveryResponse ProcessRequest(DiscoveryRequest request, IPEndPoint endpoint) 
    {
        ...
        response.hostName = $"{DataManager.username}'s game";
        response.playerCount = KGNetworkManager.instance.GetPlayerCount();
    ...
    {
        FindObjectOfType<ServerListManager>().DisplayResponse(response, endpoint.Address.ToString());
    }
